...
def retrain(imdir_def,
  ...
  parser.add_argument(
      '--learning_rate',
      type=float,
      default=learnrate_def,
      help='How large a learning rate to use when training.'
  )
  parser.add_argument(
      '--testing_percentage',
      type=int,
      default=testperc_def,
  ...
  parser.add_argument(
      '--eval_step_interval',
      type=int,
      default=evalstep_def,
      help='How often to evaluate the training results.'
  )
  parser.add_argument(
      '--train_batch_size',
      type=int,
      default=trbatchsize_def,
      help='How many images to train on at a time.'
  )
  parser.add_argument(
      '--test_batch_size',
      type=int,
      default=testbatch_def,
      help="""\
  ...
  tf.app.run(main=main, argv=['retrain.py'] + unparsed)
